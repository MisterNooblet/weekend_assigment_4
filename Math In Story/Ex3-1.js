...
function nb_year(pop , percent , newHab, goal) {
    let currentPop = pop;
    let percents = typeof percent == null? 0: percent;
    let years = 0;
    while (currentPop < goal) {
        currentPop += (Math.trunc((currentPop*percents)/100) + newHab)
        years += 1; 
    }
return years;
}
